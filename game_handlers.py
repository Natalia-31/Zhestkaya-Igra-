from image_gen import send_image_illustration  # Импортируйте вашу новую функцию!
...
async def on_pick(cb: CallbackQuery):
    ...
    await send_image_illustration(cb.bot, group_chat_id, st["current_situation"], win_ans)
